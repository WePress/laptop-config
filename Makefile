...
32:
	...
	wget https://downloads.arduino.cc/arduino-1.8.2-linux32.tar.xz;
	make deps;
	make unpack;
	make link;
	make bash;
...
link:
	...
	sudo ln -s /home/wepress/Apps/arduino-1.8.2/arduino /usr/local/bin/arduino;
